...
from configs.config import TABLE_COLLECTION
from utils.logger import get_logger

logger = get_logger("table_index")


class TableIndex:
    def __init__(self, collection_name: str = TABLE_COLLECTION):
        self.collection = get_client().get_or_create_collection(
            name=collection_name,
            metadata={"hnsw:space": "cosine"},
        )
        logger.info(f"TableIndex ready — collection: '{collection_name}', "
